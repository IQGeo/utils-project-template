...
# Watch for changes in the bundles directory and copy the files when changes are detected
# while inotifywait -r -e modify,create,delete,move /opt/iqgeo/platform/WebApps/myworldapp/public/bundles; do
#     cp -r /opt/iqgeo/platform/WebApps/myworldapp/public/bundles/* /opt/iqgeo/anywhere/bundles/
#     chown -R www-data:www-data /opt/iqgeo/anywhere/bundles
# done